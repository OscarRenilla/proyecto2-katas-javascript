// 7.1 Dado el siguiente javascript filtra los videojuegos por gender = 'RPG' usando .flter() y usa .reduce() para conseguir la media de sus .score. La función .find() también podría ayudarte para el contrar el genero 'RPG' en el array .gender.
